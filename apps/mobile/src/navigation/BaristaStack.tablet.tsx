...
import { JobsTabletScreen } from '../screens/_tablet/JobsTabletScreen';
...
import type { BaristaStackParamList } from './BaristaStack';

const Stack = createNativeStackNavigator<BaristaStackParamList>();

export const BaristaStackTablet: React.FC = () => {
