...
type UserReviewsRoute = RouteProp<{ UserReviews: { userId: string } }, 'UserReviews'>;

export const UserReviewsScreen: React.FC = () => {
  const route = useRoute<UserReviewsRoute>();
  const { t } = useTranslation();
  const userId = route.params.userId as UserId;
